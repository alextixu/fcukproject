...
if __name__ == "__main__":
    ...
    for a, b in [(x, "raw38") for x in ARMS[1:]] + [("ae_12", "ae_24_12")]:
    ...
    json.dump(out, open(os.path.join(P.XGB_EXP, "ae_shortlist_summary_arm3.json"), "w"), ensure_ascii=False, indent=1)
